...
import md5 from '@/utils/md5'; // 确保路径正确
...
describe('getHexHash', () => {
    it('should return correct SHA-256 hash for string input', () => {
        ...
        //@ts-ignore
        expect(md5(input)).toBe("fd31dc9ee2b8ad2e772c78829fb4f892");
    });
    ...
    it('should return correct SHA-256 hash for string input', () => {
        ...
        //@ts-ignore
        expect(md5(input)).toBe("5cfdfa3ddc6d6518cd8bc3bd6669cecc");
    });
    ...
    it('should return correct SHA-256 hash for empty string', () => {
        ...
        //@ts-ignore
        expect(md5(input)).toBe(expectedHash);
    });
    ...
    it('should return correct SHA-256 hash for string input', () => {
        const input = '123456';
        //@ts-ignore
        expect(md5(input)).toBe("e10adc3949ba59abbe56e057f20f883e");
    });
